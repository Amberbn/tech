...
func TestModify(t *testing.T) {
	...
	s := session.Info{
		AuthKey:    "V7O10YrjWDuYYTRxJTorcQjqHlAUGHAcul9AxXM0m4Y1XSQ1FmLXF2NeUy6aKYCwR+B3A6SU7wlOEJiHCiYrGg==",
		EncryptKey: "IdpkYU53ggbFXGse5nkyqLsFLFMHPhpsL1nJ03Sp6qI=",
		CSRFKey:    "mO5f7u1OQikyrRLjxmNZ0QirD4RdrBJhcLpcu9wcoH0=",
		Name:       "sess",
		Options:    options,
	}
